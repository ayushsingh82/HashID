...
**HashID** is a decentralized KYC solution built on the Hedera network using Eliza OS’s Hedera Starter Kit. It enables secure, AI-powered identity verification by linking a user’s KYC credentials to their Hedera ID.

---

## 🌐 Overview

HashID streamlines identity verification on the blockchain by leveraging advanced AI facial recognition and document validation. It ensures that individuals are who they claim to be—securely, transparently, and immutably.
...
- 🪪 Global ID document support (passport, driver’s license, national ID)
- 🔗 Seamless linking to Hedera ID
- 🌍 Fully decentralized and privacy-respecting
- ⚙️ Built with Eliza OS’s Hedera Starter Kit
...
1. ### 📸 Capture Your Selfie  
   Take a clear selfie using your device's camera.  
   → Our AI matches your selfie to the uploaded ID document to verify ownership.
...
2. ### 🪪 Upload ID Document  
   ...
   - Driver’s license  
   - National ID card  
   → The system supports documents from multiple countries.

3. ### 🤖 AI Verification  
   AI performs identity validation and fraud detection.

4. ### 🔗 Link to Hedera ID  
   Once verified, your identity is securely linked to your Hedera ID, enabling you to interact with dApps and services that require KYC.

---

## 🧩 Use Cases

- Onboarding to Web3 platforms requiring identity  
- Verified access to DeFi, DAO, and regulated services  
- Seamless compliance with global KYC/AML regulations  
- NFT minting for verified users  
- Identity-based voting or reputation systems

---

## 📅 Roadmap

- ✅ MVP with selfie + ID upload  
- 🔐 Privacy enhancements using zk-KYC or FHE  
- 📱 Mobile support  
- 🧾 KYC status viewer for dApps  
- 🔌 Integration with other Hedera-based services


## 🤝 Acknowledgements

- [Eliza OS](https://elizaos.xyz/)  
- [Hedera Hashgraph](https://hedera.com/)  
- Hedera Starter Kit by Eliza OS
